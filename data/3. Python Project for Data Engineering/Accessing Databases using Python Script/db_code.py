...
# Read the CSV data
file_path = r'C:\Users\SESA647993\Desktop\Continous Learning\Coursera\Python Project for Data Engineering\Accessing Databases using Python Script/INSTRUCTOR.csv'
...
# Read the CSV data
file_path = r'C:\Users\SESA647993\Desktop\Continous Learning\Coursera\Python Project for Data Engineering\Accessing Databases using Python Script/Departments.csv'
df = pd.read_csv(file_path, names = attribute_list)
# Load the CSV to the database
