...
connection = mysql.connector.connect(user='root', password='R10Iv6WpmjCdUYWGP5V2e2KV',host='172.21.38.90',database='Sales')
...
dsn_hostname = '172.21.222.205'
dsn_user='postgres'        # e.g. "abc12345"
dsn_pwd ='ysgYqSFBLXuOGB4UqhbQnqIb'      # e.g. "7dBZ3wWt9XN6$o0J"
...
def insert_records(records):
    for record in records:
	    cursor.execute(f"INSERT INTO  SALES_DATA(rowid,product_id,customer_id,quantity) VALUES{record} ON CONFLICT (rowid) DO NOTHING;");
    return conn.commit
